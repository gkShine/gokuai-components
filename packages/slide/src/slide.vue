    ...
    <section class="gk-slide" :class="{'gk-slide-fit': fit, 'gk-slide-with-toolbar': toolbar}">
        ...
        <div class="gk-slide-toolbar" v-if="toolbar">
            ...
            <div class="gk-slide-toolbar-center">
                <i v-if="center.prev" placement="top" v-tooltip :title="center.prev" class="gk-icon-angleleft" :class="{'is-disabled': selectedIndex === 0}" @click="handlePrev"></i>
                <span>{{formatText(center.text)}}</span>
                <i v-if="center.next" placement="top" v-tooltip :title="center.next" class="gk-icon-angleright" :class="{'is-disabled': selectedIndex === (list.length - 1)}" @click="handleNext"></i>
            </div>
